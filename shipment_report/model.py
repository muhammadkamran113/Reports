...
class SampleDevelopmentReport(models.AbstractModel):
    _name = 'report.shipment_report.shipment_report_arian'

    @api.model
    def render_html(self,docids, data=None):
        report_obj = self.env['report']
        report = report_obj._get_report_from_name('shipment_report.shipment_report_arian')
        ...
        return report_obj.render('shipment_report.shipment_report_arian', docargs)