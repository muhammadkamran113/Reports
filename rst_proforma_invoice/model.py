...
class SampleDevelopmentReport(models.AbstractModel):
    _name = 'report.rst_proforma_invoice.module_report'

    @api.model
    def render_html(self,docids, data=None):
        report_obj = self.env['report']
        report = report_obj._get_report_from_name('rst_proforma_invoice.module_report')
        ...
        return report_obj.render('rst_proforma_invoice.module_report', docargs)
